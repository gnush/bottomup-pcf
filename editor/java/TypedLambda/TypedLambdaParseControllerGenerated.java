...
public class TypedLambdaParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("TypedLambda");
  ...
  { 
    TypedLambdaParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = TypedLambdaParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TypedLambdaParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TypedLambdaParseControllerGenerated.class);
    }
  ...
  { 
    return TypedLambdaParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
